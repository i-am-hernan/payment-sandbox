    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <p className="text-xl mb-8">
                Find the formulas for various payment methods, payment flows and integrations that fits your needs.
                See the code and examples for each formula so you can 10X your development.
            </p>
                    ...
                    return (
                        <Card key={index} className="flex flex-col h-full">
                            ...
                            <CardFooter>
                                ...
                                <Link className="w-full" href={`/formulas/${formula._id}`}>
